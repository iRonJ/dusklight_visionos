...
DEVICE_ID="${1:-18CDEAA4-EF77-51EF-A3DF-ED311A27E277}"
BUILD_DIR="${2:-build/visionos-default}"
APP_BUNDLE="${BUILD_DIR}/Dusklight.app"
ENTITLEMENTS="/tmp/dusk_entitlements.plist"
PROVISION_PROFILE="${HOME}/Library/Developer/Xcode/UserData/Provisioning Profiles/8370c7cf-8481-4fff-b94a-93fee757c56f.mobileprovision"
SIGNING_IDENTITY="Apple Development: Ron Jailall (B2GK4YK2KT)"
...
<dict>
    ...
    <string>4Q4UKUH48B.dev.twilitrealm.dusk</string>
    <key>com.apple.developer.team-identifier</key>
    <string>4Q4UKUH48B</string>
